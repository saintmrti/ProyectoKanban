      ...
      procesos: [
        {
          ...
          data: item.ingredientes_secos
            ? convertMinutesAsHours(item.ingredientes_secos)
            : null,
        },
        {
          nombre: "Salmuerizador",
          data: item.salmuerizador
            ? convertMinutesAsHours(item.salmuerizador)
            : null,
        },
        {
          nombre: "Corte y Deshuese",
          data: item.corte_deshuese_fresco
            ? convertMinutesAsHours(item.corte_deshuese_fresco)
            : null,
        },
        {
          nombre: "Emulsiones",
          data: item.emulsiones ? convertMinutesAsHours(item.emulsiones) : null,
        },
        {
          nombre: "Mezclado",
          data: item.mezclado ? convertMinutesAsHours(item.mezclado) : null,
        },
        {
          nombre: "Embutido",
          data: item.embutido ? convertMinutesAsHours(item.embutido) : null,
        },
        {
          nombre: "Cocimiento",
          data: item.cocimiento ? convertMinutesAsHours(item.cocimiento) : null,
        },
        {
          nombre: "Enfriamiento",
          data: item.enfriamiento
            ? convertMinutesAsHours(item.enfriamiento)
            : null,
        },
        {
          nombre: "Desmolde",
          data: item.desmolde ? convertMinutesAsHours(item.desmolde) : null,
        },
        {
          nombre: "Atemperado",
          data: item.atemperado ? convertMinutesAsHours(item.atemperado) : null,
        },
        {
          nombre: "Rebanado",
          data: item.rebanado ? convertMinutesAsHours(item.rebanado) : null,
        },
        {
          nombre: "Entrega",
          data: item.entrega ? convertMinutesAsHours(item.entrega) : null,
        },
      ],
